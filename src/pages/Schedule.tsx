    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container py-12">
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight mb-4 text-white">SEASON SCHEDULE</h1>
        ...
        <Tabs defaultValue="list" className="w-full">
          ...
          <TabsContent value="list" className="space-y-4 animate-in fade-in duration-500">
            {upcomingGames.map((game) => (
              <Card key={game.id} className="overflow-hidden border-none bg-zinc-900 shadow-sm hover:shadow-md transition-all">
                <CardContent className="p-0">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="bg-red-600 text-white p-6 flex flex-col items-center justify-center min-w-[140px]">
                    ...
                    <div className="flex-grow p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                      <div className="flex items-center gap-6">
                        <div className="text-center md:text-left">
                          <Badge variant={game.type === "Home" ? "default" : "outline"} className="mb-2 bg-red-600 text-white border-none">
                            {game.type} Game
                          </Badge>
                          <h3 className="text-xl font-bold text-white">Raiders vs. {game.opponent}</h3>
                        </div>
                      </div>
          ...
          <TabsContent value="past" className="space-y-4 animate-in fade-in duration-500">
            {pastGames.map((game) => (
              <Card key={game.id} className="overflow-hidden border-none bg-zinc-900 shadow-sm opacity-80 grayscale-[0.5] hover:grayscale-0 transition-all">
                <CardContent className="p-0">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="bg-zinc-800 text-slate-400 p-6 flex flex-col items-center justify-center min-w-[140px]">
                    ...
                    <div className="flex-grow p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                      ...
                      <div className="flex items-center gap-4">
                        <div className={cn(
                          ...
                          game.result?.startsWith('W') ? "bg-green-900/20 text-green-500" : "bg-red-900/20 text-red-500"
                        )}>
                          {game.result}
                        </div>
                        <button className="text-red-500 hover:underline text-sm font-bold">
                          Recap
                        </button>
                      </div>
                    </div>
