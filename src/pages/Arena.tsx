      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[40vh] flex items-center justify-center overflow-hidden">
          <img 
            ...
            alt="Titan Memorial Arena" 
            className="absolute inset-0 w-full h-full object-cover brightness-50"
          />
          <div className="relative z-10 text-center text-white container">
            <h1 className="text-5xl font-black tracking-tighter mb-4">TITAN MEMORIAL ARENA</h1>
            <p className="text-xl text-slate-200 max-w-2xl mx-auto">The loudest house in the league. Home of the Titans since 1995.</p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  Titan Memorial Arena is a state-of-the-art multi-purpose facility located in the heart of North City. With a seating capacity of 15,000 for hockey games, it offers an intimate yet electric atmosphere that has become legendary among fans and players alike.
                </p>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="border-none shadow-md">
                    <CardHeader>
                      <CardTitle className="text-lg">Titan Treats</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground">Classic arena snacks: popcorn, nachos, and our famous "Titan Pretzel". Available at all levels.</p>
                    </CardContent>
                  </Card>
                </div>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Titan Memorial Arena is a 100% smoke-free facility."
                  ].map((policy, i) => (
            ...
            <div className="space-y-8">
              <Card className="border-none shadow-lg bg-slate-900 text-white">
                ...
                <CardContent className="space-y-4">
                  <p className="text-slate-300">123 Ice Rink Way<br />North City, ST 54321</p>
